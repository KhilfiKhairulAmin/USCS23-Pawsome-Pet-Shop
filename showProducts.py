...
from db import loadProducts, loadSession, saveOrders
...
class showProducts(EasyFrame):
    def __init__(self, type, parent=None, pagination=0):
        ...
        self.nextpage=self.addButton(text="cart",row=8,column=0,columnspan=2)
        self.back=self.addButton(text="homepage",row=8,column=2,columnspan=1,\
                                 command = self.goback)
